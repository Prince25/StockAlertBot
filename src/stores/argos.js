...
export default function argos(html) {
    ...
    if (html.includes('Sorry, PlayStation®5 is currently unavailable.')) {
        return {
            "title": "PlayStation 5",
            "image": "https://media.4rgos.it/s/Argos/8349000_R_SET?w=270&h=270&qlt=75&fmt.jpeg.interlaced=true",
            "inventory": false
        }
    }
	...
	try {
		...
		const IMAGE_SELECTOR = "div.MediaGallerystyles__ImageWrapper-sc-1jwueuh-2.eDqOMU > picture > img"
